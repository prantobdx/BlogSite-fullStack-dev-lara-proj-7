                        ...
                        <table class="table" id="dataTable">
                            ...
                            <tbody>
                              ...
                              <tr>
                                ...
                                <td>
                                    <img src="{{ $blog->blog_image }}" alt="" style="height:100px;width:100px;">
                                </td>
                                ...
                                <td>
                                    ...
                                    <a href="" class="btn btn-sm btn-danger" onclick="event.preventDefault(); confirm('Are you sure to delete this blog') ;document.getElementById('deleteForm').submit();">
