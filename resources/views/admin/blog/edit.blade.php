                        ...
                        <form action="{{ route('update-blog',['id' => $blog->id]) }}" method="post" enctype="multipart/form-data">
                            ...
                            <div class="form-group row">
                                <label for="" class="col-md-4">Blog Main Image</label>
                                  <div class="col-md-8">
                                    ...
                                    <img src="{{ asset($blog->blog_image) }}" alt="" style="height: 100px; width:100px" class="mt-1">
                                  </div>
                            </div>
                            <div class="form-group row">
                            ...
                            <div class="form-group row">
                                <label for="" class="col-md-4">Blog Status</label>                 
                                  <div class="col-md-8">
                                  <label> <input type="radio" name="status" {{ $blog->status == 1 ? 'checked' : '' }} value="1"> Published </label>
                                  <label> <input type="radio" name="status" {{ $blog->status == 0 ? 'checked' : '' }} value="0"> Unpublished </label>
                                  </div>
                            </div>
                            <div class="form-group ">
                                <input type="submit" class="btn btn-block btn-outline-info" value="Update Blog">
                            </div>
                        </form>
                    </div>
                </div>
